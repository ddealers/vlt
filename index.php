...
<!-- ******************************************** -->
		<div id="work" class="row featurette-clients y">
			<div class="col-md-8 fotoProducto">
				...
				<h1 class="solution-text variety">FOR A VARIETY OF CATEGORIES AND SHOPPER MINDSETS</h1>
			</div>
		...
		<div id="contact" class="container marketing-fondoUl">
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					...
					<a href="mailto:guadalupe.cano@visuallatina.com" class="links correo"><p>guadalupe.cano@visuallatina.com</p></a>
				...
				<div class="col-sm-6 col-md-4">
					...
					<a href="mailto:renato.tura@visuallatina.com.br" class="links correo"><p>renato.tura@visuallatina.com.br</p></a>
					...
					<a href="mailto:eugenio.bory@visuallatina.com" class="links correo"><p>eugenio.bory@visuallatina.com</p></a>
